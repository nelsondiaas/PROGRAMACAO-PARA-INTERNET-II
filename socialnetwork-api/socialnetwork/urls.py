...
urlpatterns = [
    ...
    path('api/v1/profiles-posts/<int:pk>/', PostDetail.as_view(), name='post-detail'),
    ...
    path('api/v1/posts/<int:pk_post>/comments/<int:pk_comment>/', CommentDetail.as_view(), name='comment-detail'),
